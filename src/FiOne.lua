...
Pronounced like "Fiona" with an "e".
This software aims to provide a decently fast and reliable way of executing Lua 5.1 bytecode
under other Lua environments without the use of load or loadstring.
For the purpose of anything from sandboxing to reimplementing arbitrary execution, this should serve your needs.

A fork of Rerumu's bytecode interpreter FiOne mantained by the Indirecta LUIC team with additional features for
Luau compatibility.

Contributors: Rerumu, chreen, optimisticside, TheGreatSageEqualToHeaven, ccuser44
]]
